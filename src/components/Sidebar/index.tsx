      ...
      },
      {
        icon: (
          <svg
            ...
            className="feather feather-file-check">
        ...
        <div className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5 xl:py-10">
          <Link href="/" className="flex gap-2 items-center">
            <svg
              ...
              stroke-linecap="round"
              stroke-linejoin="round"
              className="feather feather-school stroke-primary"
            >
              <path d="M12 2L1 7l11 5 9-4.09V21h2V7l-10-5z"></path>
              <path d="M7 13v3a4 4 0 1 0 8 0v-3"></path>
            </svg>
            <h1 className="font-bold">WLS-Admin</h1>
          </Link>
