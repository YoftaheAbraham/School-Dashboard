...
const AdminRegistrationHelper = () => {
    ...
    const submitHandler = (e: React.MouseEvent<HTMLFormElement>) => {
        ...
        if (formData.Role == "Teacher") {
            if (!formData.TeacherInfo || !formData.TeacherInfo?.Subject || formData.TeacherInfo?.Subject == "") {
                return
            }
        }
        console.log(formData)
                    ...
                    <div className="rounded-[10px] border border-stroke bg-white shadow-1 dark:border-dark-3 dark:bg-gray-dark dark:shadow-card">
                        ...
                        <div className="p-7">
                            <form onSubmit={submitHandler}>
                                    ...
                                    <div className="relative">
                                        ...
                                        <select
                                            onChange={(e) => {
                                                ...
                                                setFormData({ ...formData, Role: e.target.value, TeacherInfo: { Subject: "" } })
                                            }} required name="" id="" className='w-full rounded-[7px] border-[1.5px] border-stroke bg-white py-2 px-2 text-dark focus:border-primary focus-visible:outline-none dark:border-dark-3 dark:bg-dark-2 dark:text-white dark:focus:border-primary'>
                                ...
                                {
                                    formData.Role == "Teacher" && <div className="mb-5.5">
                                        <label
                                            className="mb-3 block text-body-sm font-medium text-dark dark:text-white"
                                            htmlFor="emailAddress"
                                        >
                                        ...
                                        <div className="relative">
                                            ...
                                            <select
                                                onChange={(e) => {
                                                    console.log(e.target.value)
                                                    setFormData({ ...formData, TeacherInfo: { Subject: e.target.value } })
                                                }} name="" id="" className='w-full rounded-[7px] border-[1.5px] border-stroke bg-white py-2 px-2 text-dark focus:border-primary focus-visible:outline-none dark:border-dark-3 dark:bg-dark-2 dark:text-white dark:focus:border-primary'>
                                                <option value="">Select Subject</option>
                                                <option value="78878787">Chemistry (G11 | G12)</option>
                                                <option value="89988989">Biology(G10 | G9)</option>
                                                <option value="87182788">Mathematics(G10 | G9)</option>
                                            </select>
                                        </div>
                                    </div>
                                }
...
export default AdminRegistrationHelper;
