...
const OverallAnnouncementHelper = () => {
    return (
        <div className="rounded-[10px] flex border border-stroke bg-white px-4 py-2 shadow-1 dark:border-dark-3 dark:bg-gray-dark dark:shadow-card sm:p-7.5">
            <div className="max-w-full flex flex-col items-center justify-between gap-3 overflow-x-auto no-scrollbar dark:scrollbar-thumb-dark-3 dark:scrollbar-track-gray-dark">
                <svg
...
export default OverallAnnouncementHelper